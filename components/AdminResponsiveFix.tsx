...
export default function AdminResponsiveFix(){
  return <style jsx global>{`
    ...
    @media(max-width:1100px){
      .admin-page{width:100%!important;max-width:100%!important;padding:16px!important;overflow-x:hidden!important}
    ...
    /* Tablet: two-column form fields become one column before they can feel cramped. */
    ...
    /* Phone: simple single-column app layout with a compact floating navigation. */
    @media(max-width:640px){
      .admin-page{padding:10px 10px 96px!important}
      ...
      .admin-main .form-savebar .btn{width:auto!important;min-width:0!important;max-width:max-content!important;padding:0 18px!important;border-radius:10px!important}
      ...
      .admin-nav{display:flex!important;position:fixed!important;z-index:100!important;left:50%!important;right:auto!important;bottom:8px!important;transform:translateX(-50%)!important;width:calc(100% - 16px)!important;max-width:520px!important;height:68px!important;min-height:0!important;margin:0!important;padding:5px!important;border-radius:18px!important;overflow:hidden!important;flex-direction:row!important;align-items:stretch!important;gap:0!important}
      ...
      .admin-nav .nav-group button{flex:1 1 0!important;width:auto!important;min-width:0!important;min-height:56px!important;height:56px!important;margin:0!important;padding:4px 1px!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:2px!important;border-radius:10px!important;font-size:8.5px!important;line-height:1.05!important;text-align:center!important;white-space:normal!important;overflow:hidden!important}
      .admin-nav .nav-group button:before{width:auto!important;height:18px!important;margin:0!important;display:grid!important;place-items:center!important;font-size:15px!important;line-height:1!important}
