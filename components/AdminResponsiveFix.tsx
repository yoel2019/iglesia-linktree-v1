...
export default function AdminResponsiveFix(){
 return <style jsx global>{`
  ...
  .admin-main .link-detected{display:flex;align-items:center;gap:7px;margin:-2px 0 12px;padding:8px 10px;border:1px solid rgba(255,255,255,.08);border-radius:10px;color:var(--muted,#b8c1d0);font-size:12px;min-width:0}
  .admin-main .link-detected small{margin-left:auto;opacity:.72;font-size:11px}
  .admin-main .link-icon-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:14px;align-items:end;min-width:0}
  .admin-main .link-icon-row .field{min-width:0;width:100%}
  .admin-main .icon-picker{min-width:0;max-width:100%}
  ...
  .admin-main .link-actions{display:flex;align-items:center;gap:8px;width:100%;margin-top:12px;min-width:0}
  ...
  @media(max-width:640px){
   ...
   .admin-main .icon-picker{grid-template-columns:repeat(4,minmax(0,1fr))!important;overflow:visible!important}
